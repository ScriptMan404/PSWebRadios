...
if ($VLCProcess -eq $null) {
    $VLCProcess = Start-Process -WindowStyle Hidden -PassThru -FilePath "vlc.exe" -WorkingDirectory "C:\Program Files\VideoLAN\VLC" -ArgumentList $WRStream.url_resolved
} else {
